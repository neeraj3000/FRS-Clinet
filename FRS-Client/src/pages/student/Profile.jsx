    ...
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '85vh', backgroundColor: '#f9f9f9', p: 2 }}>
      <Paper sx={{ p: 3, maxWidth: 800, width: '100%', boxShadow: 3, borderRadius: 2, backgroundColor: '#ffffff' }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
          <Typography variant="h5" sx={{ color: '#1a237e' }}>Student Profile</Typography>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1"><BusinessIcon /> {`${adminInfo.year} ${adminInfo.branch}`}</Typography>
            <Typography variant="body1"><SchoolIcon /> {adminInfo.section}</Typography>
          </Grid>
        </Grid>
      </Paper>
    </Box>
